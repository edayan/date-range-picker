...
(function(factory) {
    ...
    $.dateRangePickerLanguages = {
        'default': //default language: English
        {
            ...
            'default-start': 'Please select arrival date',
            'default-end': 'Please select departure date',
            'time': 'Time',
            'hour': 'Hour',
            'minute': 'Minute'
        }
    ...
    $.fn.dateRangePicker = function(opt) {
        ...
        function init_datepicker() {
            ...
            if (opt.minDays && opt.maxDays)
                ...
                defaultTopText = opt.endDateField ? lang('default-end') : lang('default-start');
        ...
        function open(animationTime) {
            if (opt.endDateField && !opt.getSelectedStartDate()) {
                opt.askToSelectStartDateFirst();
                return;
            }
            calcPosition();
            redrawDatePicker();
            checkAndSetDefaultValue();
            setDateValuesFromDom();
        ...
        function setDateValuesFromDom() {
            if (!opt.endDateField) {
                opt.end = opt.getSelectedEndDate();
            } else {
                opt.start = opt.getSelectedStartDate();
            }
        }
        ...
        function dayHovering(day) {
            if ((!opt.endDateField && opt.getSelectedEndDate()) || (opt.endDateField && opt.getSelectedStartDate())) {
        ...
        function createDom() {
            ...
            html += '<div class="month-wrapper">' +
                '<table id=' + opt.tableId + ' class="month1" cellspacing="0" border="0" cellpadding="0"><thead><tr class="caption"><th style="width:27px;"><span class="prev">&lt;</span></th><th colspan="' + _colspan + '" class="month-name"></th><th style="width:27px;">' + (opt.singleDate || !opt.stickyMonths ? '<span class="next">&gt;</span>' : '') + '</th></tr><tr class="week-name">' + getWeekHead() + '</thead><tbody></tbody></table>';
